...
const METRICS = [
  ...
  {
    value: "40%",
    label: "Decrease in page load times for core banking dashboard.",
    color: "text-pink-300",
  },
];
...
const SKILLS = {
  Frontend: {
    icon: "terminal",
    color: "violet",
    tags: ["Angular v17+", "React", "TypeScript", "React Native"],
  },
  Backend: {
    icon: "database",
    color: "purple",
    tags: ["Django", "Flask", "Spring Boot", "Node.js"],
  },
  "Design / UI": {
    icon: "palette",
    color: "pink",
  ...
  "Infra & Tools": {
    icon: "construction",
    color: "indigo",
    tags: ["Git", "Docker", "Redis", "Sentry", "PostgreSQL"],
  },
};
...
const PROJECTS = [
  {
    ...
    result:
      "Architected scalable codebase supporting 1200+ students across multiple forms with feature-based folder structure and 60%+ code reusability through component composition.",
    tags: [
      "Angular 20",
      "Spring Boot",
      "TypeScript",
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition-all duration-500 ${
        scrolled
          ? "bg-[#050b1a]/90 backdrop-blur-2xl shadow-xl shadow-black/30"
          : "bg-transparent"
      }`}
    >
      <div className="flex justify-between items-center max-w-7xl mx-auto px-6 md:px-12 h-20">
        ...
        <a
          href="mailto:jecintawangui2001@gmail.com"
          className="bg-violet-600 hover:bg-violet-500 text-white font-semibold px-5 py-2.5 rounded-full text-sm transition-all hover:scale-105 active:scale-95"
        >
          Get in touch
        </a>
      </div>
...
function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="max-w-7xl mx-auto px-6 md:px-12 pt-36 pb-28 relative"
    >
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-lg text-slate-400 max-w-xl leading-relaxed">
            Building scalable, high-performance web applications with Angular,
            React, and Django. Focused on clean code and measurable user impact.
          </p>

          <div className="flex flex-wrap gap-4 pt-2">
            <a
              href="#projects"
              className="bg-violet-600 hover:bg-violet-500 text-white px-7 py-3.5 rounded-xl font-bold text-base transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
              View Projects
            </a>
            <a
              href="#"
              className="bg-white/5 hover:bg-white/10 text-white px-7 py-3.5 rounded-xl font-bold text-base border border-white/10 transition-all"
            >
              Download Resume
            </a>
          </div>
        ...
        >
          <div className="aspect-square rounded-2xl overflow-hidden bg-slate-800 border border-white/10 relative z-10">
            <img
              ...
              alt="Jess Wangui — Full-Stack Developer"
...
function Metrics() {
  const [ref, inView] = useInView();
  return (
    <section ref={ref} className="max-w-7xl mx-auto px-6 md:px-12 mb-28">
      <div
        className={`relative bg-white/[0.03] border border-white/10 rounded-2xl p-10 md:p-14 overflow-hidden transition-all duration-700 ${
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {METRICS.map((m, i) => (
            ...
            >
              <div
                className={`text-5xl font-extrabold font-['Poppins',sans-serif] ${m.color}`}
              >
                {m.value}
              </div>
...
function SkillCard({ name, data, delay = 0 }) {
  ...
  return (
    <div
      ref={ref}
      className={`bg-white/[0.03] border border-white/10 ${c.border} rounded-2xl p-7 transition-all duration-700 ${
        inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
      }`}
...
function Skills() {
  return (
    <section id="skills" className="max-w-7xl mx-auto px-6 md:px-12 mb-28">
      ...
      <div className="bg-[#0b1325] border border-white/10 rounded-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="sticky top-0 bg-[#0b1325]/95 backdrop-blur border-b border-white/10 px-8 py-5 flex justify-between items-center z-10">
          <div>
            ...
            <p className="text-xs text-violet-400 font-semibold tracking-widest uppercase mt-0.5">
              {project.subtitle}
            </p>
          </div>
          <button
        ...
        <div className="p-8 space-y-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              <div>
                <h5 className="text-xs font-bold uppercase tracking-widest text-violet-400 mb-3">
                  Project Overview
                </h5>
              ...
              <div>
                ...
                <p className="text-violet-200 font-medium text-sm bg-violet-500/10 border border-violet-500/20 rounded-xl px-5 py-4">
                  {project.result}
                </p>
              </div>

              {/* Key Features for EduPulse */}
              {project.keyFeatures && (
                <div>
                  <h5 className="text-xs font-bold uppercase tracking-widest text-violet-400 mb-3">
                    Key Features
            ...
            <div className="bg-white/[0.03] rounded-xl p-6 border border-white/10 space-y-5 h-fit">
              <h5 className="text-xs font-bold uppercase tracking-widest text-violet-400">
                Architecture
              </h5>
          ...
          {/* Gallery */}
          <div>
            <h5 className="text-xs font-bold uppercase tracking-widest text-violet-400 mb-6">
              Interface Gallery
            </h5>
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col flex-1">
          ...
          <p className="text-violet-300 text-sm font-medium mb-5">
            → {project.result}
          </p>
          ...
          <div className="flex flex-wrap items-center gap-3 mt-auto">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-bold text-white bg-violet-600 hover:bg-violet-500 rounded-lg transition-all hover:scale-[1.02]"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-bold text-violet-300 border border-violet-500/30 hover:border-violet-400 rounded-lg bg-transparent transition-colors"
            >
...
function Projects() {
  return (
    <section id="projects" className="max-w-7xl mx-auto px-6 md:px-12 mb-28">
      <div className="flex justify-between items-end mb-14">
        <div>
          <h2 className="text-3xl font-extrabold font-['Poppins',sans-serif] text-white mb-3">
            Featured Projects
          </h2>
          <p className="text-slate-400 max-w-lg text-sm">
            Selected works that showcase full-stack proficiency and user-centred
            design thinking.
          </p>
        </div>
        <button className="text-violet-400 font-bold text-sm flex items-center gap-1 hover:translate-x-1 transition-transform hidden md:flex">
          View All Projects
...
function CTA() {
  ...
  return (
    <section ref={ref} className="max-w-7xl mx-auto px-6 md:px-12 mb-28">
      <div
        className={`relative bg-gradient-to-br from-violet-600/10 to-purple-600/5 border border-violet-500/20 rounded-2xl p-14 text-center overflow-hidden transition-all duration-700 ${
          inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
        }`}
      >
        <GlowOrb className="top-0 left-1/2 -translate-x-1/2 w-96 h-48 bg-violet-500/15" />
        <div className="relative z-10">
          <h2 className="text-4xl md:text-5xl font-extrabold font-['Poppins',sans-serif] text-white mb-6">
            Let's build something impactful.
          </h2>
          <p className="text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Whether you're looking to scale an existing platform or build a new
            vision from scratch, I bring the technical depth and design focus to
            make it happen.
          </p>
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <a
              href="mailto:hello@jesswangui.dev"
              className="bg-violet-600 hover:bg-violet-500 text-white px-9 py-4 rounded-xl font-bold text-base inline-flex items-center justify-center gap-2 transition-all hover:scale-105"
            >
            ...
            <a
              href="#"
              className="bg-white/5 hover:bg-white/10 text-white px-9 py-4 rounded-xl font-bold text-base border border-white/10 inline-flex items-center justify-center gap-2 transition-all"
            >
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex gap-12">
          {[
            ...
            { title: "General", links: ["Resume", "Process", "Contact"] },
          ].map((col) => (
            <div key={col.title} className="flex flex-col gap-3">
              ...
              {col.links.map((l) => (
                <a
                  key={l}
                  href="#"
                  className="text-slate-600 hover:text-violet-400 transition-colors text-sm"
                >
                  {l}
                </a>
              ))}
...
export default function App() {
  return (
    <>
      ...
      <link
        rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&family=DM+Sans:wght@300;400;500;600&display=swap"
      />
      <link
        rel="stylesheet"
      ...
      <div
        ...
        style={{
          backgroundColor: "#0b1325ff",
          color: "#fbfbffff",
          fontFamily: "'DM Sans', sans-serif", // Keep DM Sans as body, or change to "'Poppins', sans-serif" if desired globally
        }}
      >
        <Navbar />
        <main>
