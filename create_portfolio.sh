...
export const SKILLS = {
  Frontend: { icon: "terminal", color: "violet", tags: ["Angular v17+", "React", "TypeScript"] },
  Backend: { icon: "database", color: "purple", tags: ["Django", "Flask", "Spring Boot"] },
  "Design / UI": { icon: "palette", color: "pink", tags: ["Tailwind CSS", "Material UI", "Responsive Design", "Figma"] },
  "Infra & Tools": { icon: "construction", color: "indigo", tags: ["Git", "Docker", "Github Actions", "Sentry", "PostgreSQL"] },
};
